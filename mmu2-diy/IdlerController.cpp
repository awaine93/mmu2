...
void IdlerController::unParkIdler() {
	...
	Serial.print("application.filamentSelection: ");Serial.println(application.filamentSelection);
	Serial.print("bearingAbsPos :  ");Serial.println(bearingAbsPos[application.filamentSelection]);
	...
	Serial.print("rollerSetting :  ");Serial.println(rollerSetting);
...
/* void IdlerController::select(char filament) {
	...
	int intFilament = (int) filament - 0x30;
	// move the selector back to it's origin state
	
	Serial.print("filament: ");Serial.println(intFilament);
	Serial.print("bearingAbsPos/ newBearingPos: ");Serial.println(bearingAbsPos[intFilament]);
	newBearingPosition = bearingAbsPos[intFilament];                         // idler set to 1st position

	application.filamentSelection = intFilament;
	application.currentExtruder = filament;
	
	Serial.print("oldBearingPosition: ");Serial.println(oldBearingPosition);
	newSetting = newBearingPosition - oldBearingPosition;

	Serial.print("newSetting: ");Serial.println(newSetting);
...
void IdlerController::turnamount(int steps, int dir) {
	int i;
	Serial.print("turnamm::steps :: ");Serial.println(steps);
